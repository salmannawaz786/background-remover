...
const SENDER_EMAIL = 'info@sallulabs.com';
const SENDER_NAME = 'SalluLabs Watermark Remover';
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f5f5f5; padding: 40px 20px;">
        <tr><td align="center">
            <table width="100%" max-width="500" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.1); overflow: hidden;">
                <tr><td style="background: linear-gradient(135deg, #FACC15 0%, #F59E0B 100%); padding: 30px; text-align: center;">
                ...
                <tr><td style="background-color: #f9f9f9; padding: 25px 30px; border-top: 1px solid #eee;">
    ...
    try {
        ...
        if (result.success && result.accessToken) {
            ...
            if (!userDoc.exists()) {
                ...
                showMessage(`🎉 Welcome ${user.displayName || 'to Watermark Remover'}!`, 'success');
            } else {
